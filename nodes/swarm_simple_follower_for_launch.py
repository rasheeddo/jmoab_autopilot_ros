...
class SwarmSimpleFollower(object):
	...
	def __init__(self, param_file, group_ns, master_ns, follower_ns):
...
if __name__ == "__main__":
	...
	parser.add_argument('--group_ns',
						help="A group name of swarm simple follower")
	...
	if group_ns is None:
		print("Please provide namespace of group")
		quit()


	a = SwarmSimpleFollower(yaml_path, group_ns, master_ns, follower_ns)